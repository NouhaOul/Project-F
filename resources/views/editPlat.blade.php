      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <form action="{{route('updatePlat', $plat->id)}}" method="POST" class="tm-edit-product-form">
              @csrf
              @method('PUT')
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block text-uppercase">UPDATE PLAT Now</button>
              </div>
            </form>
            </div>
          </div>
